...
-- get_archive_candidates(source_location, max_downloads)
-------------------------------------------------------------------------------
-- Returns the (package, filename) of every file currently at
-- *source_location* whose build received fewer than *max_downloads*
-- downloads in the last month; these are candidates for moving to the
-- archive.
-------------------------------------------------------------------------------
...
-- get_unarchive_candidates(source_location, min_downloads)
-------------------------------------------------------------------------------
-- Returns the (package, filename) of every file currently at
-- *source_location* whose build received more than *min_downloads*
-- downloads in the last month; these are candidates for moving back from
-- the archive.
-------------------------------------------------------------------------------
...
-- set_files_location(filenames, new_location)
-------------------------------------------------------------------------------
-- Updates the "location" of every file named in *filenames* to
-- *new_location*; used once files have been physically copied between the
