(function() {
  ...
  function toggleFiles(btn, filesTableId) {
    if (btn.innerHTML === '+') {
  ...
  function showInstall(btn) {
    const package = document.getElementById('package').textContent;
    const row = btn.parentNode.parentNode;
    const dependencies = row.getElementsByClassName('dependencies')[0].textContent;
    const version = row.getElementsByClassName('version')[0].textContent;
